      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <nav className="text-sm text-gray-600 space-y-2">
          <ul className="list-disc list-inside space-y-1">
            <li><a href="#" className="text-purple-600 hover:underline">Foundations of AI for Business</a></li>
            <li>Technical Essentials</li>
            <li>AI Strategy and Implementation</li>
            <li>AI Applications in Business</li>
            <li>Ethical and Organizational Considerations</li>
            <li>Capstone</li>
          </ul>
        </nav>
        <div className="md:col-span-2 bg-white p-6 rounded shadow">
          <div className="mb-6">
            <h3 className="font-bold text-gray-900 mb-2">AI/ML Fundamentals for CxOs</h3>
            <p className="mb-4">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700">
              <li className="flex items-start">
                <svg className="flex-shrink-0 h-5 w-5 text-purple-500 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-2">Building Leadership Strategies for AI</h3>
            <p className="mb-4">
