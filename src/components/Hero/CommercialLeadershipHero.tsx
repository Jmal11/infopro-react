...
const heroBg = 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80'; // Placeholder background
const heroImg = 'https://randomuser.me/api/portraits/women/44.jpg'; // Placeholder right-side image

export function CommercialLeadershipHero() {
  return (
    <section className="relative w-full h-[80vh] flex items-center bg-gray-900 overflow-hidden">
      ...
      <div className="relative z-10 flex w-full h-full items-center justify-between px-12 pt-16">
        ...
        <div className="max-w-xl text-white flex flex-col gap-6">
          <h1 className="text-5xl font-bold leading-tight">Commercial Leader Development</h1>
          <p className="text-lg">Develop your sales leadership skills with specialized training for strategic growth and performance</p>
...
export default CommercialLeadershipHero; 