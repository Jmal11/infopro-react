...
export function CommercialLeadershipHero() {
  return (
    <section
      ...
      style={{ backgroundImage: "url('https://www.infoprolearning.com/wp-content/themes/ipl/assets/images-new/2024/Commercial_Leader_Development_Banner.webp')" }}
    >
      <div className="absolute inset-0"></div>
      <div className="container mx-auto px-4 flex items-center h-full relative z-10">
        <div className="max-w-xl text-white">
          <h1 className="text-5xl font-bold mb-4">Commercial Leader Development</h1>
          <p className="mb-6 text-xl font-normal">
          Develop your sales leadership skills with specialized
          training for strategic growth and performance
          </p>
