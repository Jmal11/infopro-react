...
export function PeopleLeadershipHero() {
  return (
    <section className="bg-gray-900 text-white py-20 px-6 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
      <div className="lg:w-1/2">
        <h1 className="text-4xl font-bold mb-6">Leading Teams</h1>
        <p className="mb-8 max-w-md">
          Developing leaders who excel at fostering a team culture and nurturing individuals to build an optimal team-based success environment
        </p>
...
export default PeopleLeadershipHero;
