    ...
    <div className="bg-white min-h-screen py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">Workforce Transformation</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border border-gray-300 rounded-lg p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-200/50 hover:border-purple-300 group cursor-pointer">
            <h2 className="text-xl font-semibold text-center mb-8 text-gray-800 group-hover:text-purple-600 transition-colors">Develop Talent</h2>
            ...
            <div className="text-center border-t border-gray-200 pt-4">
              <p className="text-purple-600 font-semibold">Speed to Proficiency</p>
            </div>
          </div>
          ...
          <div className="border border-gray-300 rounded-lg p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-yellow-200/50 hover:border-yellow-300 group cursor-pointer">
            <h2 className="text-xl font-semibold text-center mb-8 text-gray-800 group-hover:text-yellow-600 transition-colors">Empower Teams</h2>
            ...
            <div className="text-center border-t border-gray-200 pt-4">
              <p className="text-yellow-600 font-semibold">Accelerate Growth</p>
            </div>
          </div>
          ...
          <div className="border border-gray-300 rounded-lg p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-teal-200/50 hover:border-teal-300 group cursor-pointer">
            <h2 className="text-xl font-semibold text-center mb-8 text-gray-800 group-hover:text-teal-600 transition-colors">Transform Organization</h2>
            ...
            <div className="text-center border-t border-gray-200 pt-4">
              <p className="text-teal-600 font-semibold">Amplify Business Agility</p>
            </div>
          </div>
        </div>
      </div>
